...
def handle_transformers(model, operations, image, label, gt_image):
    ...
    for operation in operations:
        if operation == 'gae':
            ...
            im3, score, heatmap_cv, blended_img_mask, heatmap, t = blend_transformer_heatmap(image, dix_attribution)
            img_dict.append({"image": im3, "title": DIX})
